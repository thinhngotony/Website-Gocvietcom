...
(function ($) {
    ...
    var AcfMap = function(el, options)
    {
        ...
        var defaultOptions = {
            zoom: parseFloat($(base.el).attr('data-zoom') || 16),
            onAppendMarker:function(){},
            // Used to turn generic javasript objct to marker
            mapObjectAsMarker:function(object){

                var location = {lat: parseFloat(object.lat), lng: parseFloat(object.lng)};
        ...
        base.init = function(){
            // var
            var $markers = base.$el.find('.marker');
            ...
            // create map
            map = new google.maps.Map( base.$el[0], args);
            map.setOptions({style:styles});
            ...
            $markers.each(function(){
                base.add_marker($(this));
            });

            var icon = wp.template_url + '/dist/images/cluster-single.png';
            //var markerImage = new google.maps.MarkerImage(wp.template_url + '/dist/images/cluster.png',
            ...
            if (base.options.useClusters == true) {
                cluster = new MarkerClusterer(map, markers, mcOptions);
            ...
            google.maps.event.addListener(map, 'click', function(event) {
                //window.location = this.mapUrl;
            });
            google.maps.event.trigger(map, "resize");
            google.maps.event.addListenerOnce(map, 'idle', function(){
                base.options.onFirstLoad(base);
            });
        ...
        base.makePopup = function(el){
            console.log(el.phone);

            var phone = 'no phone';
            if (el.phone != null){
                phone = "<a class='phone' href='tel:" + el.number + "'>" + el.phone + "</a>";
            }
            var address = el.address.replace(',', ',<br>');
            return '<div class="map-popup">' +
                '<h4>'+ el.post_title +'</h4>' +
                '<address>'+address+'</address>' +
                phone +
                '<a class="more" href="'+el.guid+'">More</a>' +
                '</div>';
        };
        ...
        base.add_marker = function( $marker ) {
            ...
            var newmarker = new google.maps.Marker({
                ...
                icon        : wp.template_url + '/dist/images/geo.png'
            });
            ...
            //base.options.onAppendMarker.call( newmarker );
        ...
        base.appendMarker= function(object){

            var location = {lat: parseFloat(object.lat), lng: parseFloat(object.lng)};

            var infowindow = new google.maps.InfoWindow({
                content: base.makePopup(object)
            });
            ...
            base.options.onAppendMarker.call( marker );
            base.center_map();
        ...
        base.setMapOnAll =  function(newMap) {
                for (var i = 0; i < markers.length; i++) {
                    markers[i].setMap(newMap);
                }
        },

        base.replaceMarkers = function(newMarkers){
            this.removeAllMarkers();
            for(var i=0; i < newMarkers.length; i++){
               base.appendMarker(newMarkers[i]);
            };
            this.center_map();
        }


        base.appendObjectAsMarker = function(object){
            var marker = base.options.mapObjectAsMarker(object);
            markers.push(marker);
            base.center_map();
            base.options.onAppendMarker.call(marker);
        },
        ...
        this.removeAllMarkers = function() {
            ...
            base.setMapOnAll(null);
            markers = [];

            google.maps.event.trigger(map, "resize");
        }

        base.positionMap = function(lat, lng, zoom){
    ...
    AcfMap.defaultOptions = {
        onAppendMarker:function(){
        }
    };


    $.fn.acfMap = function(options){
        ...
        return this.each(function(){
            ...
            if (element.data('acfMap')) return;

            var myplugin = new AcfMap(this, options);
            console.log(myplugin);

            // Store plugin object in this element's data
            element.data('acfMap', myplugin);

        });
        */
        return new AcfMap(this, options);
