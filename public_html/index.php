...
<head>
  ...
  <link rel="stylesheet" id="theme-style-css" href="http://www.gocviet.com.vn/slider/theme-style.css" type="text/css"
    media="all">
  <link rel="stylesheet" id="shortcodes-css" href="http://www.gocviet.com.vn/slider/shortcodes.css" type="text/css"
    media="all">
  <link rel="stylesheet" id="prettyPhoto-css" href="http://www.gocviet.com.vn/slider/prettyPhoto.css" type="text/css"
    media="all">
  <link rel="stylesheet" id="style-css" href="http://www.gocviet.com.vn/slider/style.css" type="text/css" media="all">
  <link rel="stylesheet" id="custom-css" href="http://www.gocviet.com.vn/slider/custom.css" type="text/css" media="all">
  ...
  <div id="page-wrap">
    <div class="anythingSlider">
      <div class="anythingWindow">
        <ul id="slider1">
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide3-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide4-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide7-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide9-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide10-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide11-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide2-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
          <li
            style="background: url(http://www.gocviet.com.vn/images/slide3-new.jpg) top center no-repeat; width:100%; height:100%;">
          </li>
    ...
    <div id="header">
      <div class="grid_16 navigation-container">
        ...
        <div align="center" id="country_selector" style="background-color:#FFFFFF;">
          <a href="home.php">
            <font style="font-size:13px; font-family:Arial;"><span
                style="color:#000000; text-shadow: 0.1em 0.1em 0.2em #000000">WELCOME</span></font>
          </a>
        </div>
      </div>
    </div>
