...
buildmenu:function(menuid, arrowsvar){
	jQuery(document).ready(function($){
		var $mainmenu=$("#"+menuid+">ul,#"+menuid+"*ul")
		...
		$headers.each(function(i){
			...
			$curobj.children("a:eq(0)").css(this.istopheader? {paddingRight: arrowsvar.down[2]} : {}).append(
				'<span class="arrow ' + (this.istopheader? arrowsvar.down[0] : arrowsvar.right[0])
				+ '">&nbsp;</span>'
			)
			$curobj.hover(
				function(e){
...
jqueryslidemenu.buildmenu("navigation>div", arrowimages)