 ...
 (function($) {
    ...
    $.anythingSlider = function(el, options) {
        ...
        base.init = function() {
            ...
            // change so this works in jQuery 1.3.2
            base.win = window;
            base.$win = $(base.win);
            ...
            base.timer = null;
            // slideshow timer (setInterval) container
            base.flag = false;
            // event flag to prevent multiple calls (used in control click/focusin)
            base.playing = false;
            // slideshow state
            base.slideshow = false;
            // slideshow flag
            base.hovered = false;
            // actively hovering over the slider
            base.panelSize = [];
            // will contain dimensions and left position of each panel
            base.currentPage = base.options.startPanel;
            base.adjustLimit = (base.options.infiniteSlides) ? 0: 1;
            // adjust page limits for infinite or limited modes
            ...
            var triggers,
            startPanel = (base.options.hashTags) ? base.gotoHash() || base.options.startPanel: base.options.startPanel;
            base.setCurrentPage(startPanel, false);
            // added to trigger events for FX code
            // Hide/Show navigation & play/stop controls
            base.slideControls(false);
            base.$wrapper.bind('mouseenter mouseleave',
            function(e) {
            ...
            $.each("onShowPause onShowUnpause onSlideInit onSlideBegin onShowStop onShowStart onInitialized onSWFComplete".split(" "),
            function(i, o) {
            ...
            if (base.options.animationType == 'fade') {
              base.$el.children().css({'position':'absolute','left':0,'top':0});
              base.$el.find(':not(:eq(0))').hide();
            }
        ...
        base.updateSlider = function() {
            ...
            if (base.pages <= 1) {
                ...
                if (base.options.autoPlay) {
                    ...
                    // Sets the playing variable to false if startStopped is true
                    base.buildAutoPlay();
                }
            ...
            // embedded youtube objects exist in the slider
            ...
            base.$items.find('a').unbind('focus').bind('focus',
            function(e) {
        ...
        base.buildNavigation = function() {
            ...
            if (base.options.buildNavigation && (base.pages > 1)) {
                base.$items.filter(':not(.cloned)').each(function(i) {
                    ...
                    // use $a.parent() so it will add <li> instead of only the <a> to the <ul>
                    ...
                    $a.bind(base.options.clickControls,
                    function(e) {
        ...
        base.buildNextBackButtons = function() {
            ...
            base.$back.bind(base.options.clickArrows,
            function(e) {
                base.goBack();
                e.preventDefault();
            });
            base.$forward.bind(base.options.clickArrows,
            function(e) {
                base.goForward();
                e.preventDefault();
            });
            // using tab to get to arrow links will show they have focus (outline is disabled in css)
            base.$back.add(base.$forward).find('a').bind('focusin focusout',
            function() {
        ...
        base.buildAutoPlay = function() {
            ...
            base.$startStop
            .bind(base.options.clickSlideshow,
            function(e) {
        ...
        base.setDimensions = function() {
            ...
            base.$items.each(function(i) {
                ...
                if (base.options.resizeContents) {
                    ...
                    w = $(this).width();
                    // if not defined, it will return the width of the ul parent
                    dw = (w >= winw) ? true: false;
                    // width defined from css?
                    if (c.length === 1 && dw) {
                        cw = (c.width() >= winw) ? bww: c.width();
                        // get width of solitary child
                        $(this).css('width', cw);
                        // set width of panel
                        c.css('max-width', cw);
        ...
        base.getDim = function(page) {
            ...
            var i;
         	var w = base.panelSize[page][0];
         	var h = base.panelSize[page][1];
            if (base.options.showMultiple > 1) {
        ...
        base.gotoPage = function(page, autoplay, callback) {
            ...
            if ( base.options.animationType == 'slide') {
              // Animate Slider
            ...
            } else if ( base.options.animationType == 'fade') {
              
              base.$lastPage.fadeOut(base.options.animationTime);
              base.$currentPage.fadeIn(base.options.animationTime,function() {
                  base.endAnimation(page, callback);
              });
            }
        };
        ...
        base.setCurrentPage = function(page, move) {
            ...
            if (!move) {
                ...
                if (base.options.animationType == 'slide'){
                  // reset in case tabbing changed this scrollLeft
        ...
        base.checkVideo = function(playing) {
            ...
            base.$items.find('object[id*=ytvideo], embed[id*=ytvideo]').each(function() {
                // include embed for IE; if not using SWFObject, old detach/append code needs "object embed" here
                emb = $(this);
    ...
    $.anythingSlider.defaults = {
        ...
        // Stop button text
        delay: 3000,
        // How long between slideshow transitions in AutoPlay mode (in milliseconds), default 4000
        resumeDelay: 10000,
        // Resume slideshow after user interaction, only if autoplayLocked is true (in milliseconds), default 10000
        animationTime: 600,
        // How long the slideshow transition takes (in milliseconds), default 600
        ...
        return this.each(function() {
            ...
            if ((typeof(options)).match('object|undefined')) {
                ...
                if (page >= 1 && page <= anySlide.pages) {
                    ...
                    // page #, autoplay, one time callback
                }
            }
        });
    };
