	...
	$("a[rel^='prettyPhoto']").prettyPhoto({animationSpeed:'slow',theme:'pp_default',slideshow:6000});*/

/*jQuery(".gallery-icon a").prettyPhoto({animationSpeed:'normal',theme:'pp_default', show_title : false}); jQuery("a[rel^='prettyPhoto'], .gallery-icon a").prettyPhoto({animationSpeed:'normal',theme:'pp_default', show_title : false});
